...
secret_name = "matars-google-data"
...
SERVICE_ACCOUNT = os.environ.get('EE_SERVICE_ACCOUNT', 'google-cloud-data@algotrading-478022.iam.gserviceaccount.com')
KEY_FILE = os.environ.get('EE_KEY_FILE')
GCS_BUCKET = os.environ.get('GCS_BUCKET','polution_data')

GCS_PREFIX = os.environ.get('GCS_PREFIX', 'google/s5p_co2/2024')

S3_BUCKET = os.environ.get('S3_BUCKET','caff-dump')
S3_PREFIX = os.environ.get('S3_PREFIX', 'google/s5p_co2/2024')
